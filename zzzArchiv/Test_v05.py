...
def wtp_Matching_alt():
    abt_table = pd.read_excel('Data/20200917_Zahlungsbereitschaft_v01_aw.xlsx', sheet_name = 'Zahlungsfähigkeit_Bereinigt')
    cons_aware = pd.read_excel('Data/20200917_Zahlungsbereitschaft_v01_aw.xlsx', sheet_name = 'Konsumentennähe')
    wtp_val_list = pd.read_excel('Data/20200917_Zahlungsbereitschaft_v01_aw.xlsx', sheet_name = 'Zahlungsbereitschaften_ALT')
...
def max_wtp_Calculation(wtp_list):
    ...
    el_cost = pd.read_excel('Data/20200917_Zahlungsbereitschaft_v01_aw.xlsx', sheet_name = 'Strompreise')
...
def assume_industry_demand():
    ind_dem = pd.read_excel('Data/20200917_Stromverbräuche_v01_aw.xlsx', sheet_name = 'Industrie') #Nachfrage eines Durchschnittsunternehmens!
    ind_no = pd.read_excel('Data/20200917_Stromverbräuche_v01_aw.xlsx', sheet_name = 'Anzahl Unternehmen')
  ...
  #  ind_dem_assum = pd.DataFrame(columns=["Land","Sektor", "Größe"])
    ...
    complete_sector.to_csv('Data\inddem_complete.csv', index = None, sep=";", mode="a")                   
    return merged 
